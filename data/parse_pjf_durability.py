#!/usr/bin/env python3
"""Parse the PJF Durability Code Prime PDF text into structured JSON.

Strategy: walk line-by-line. Track current week/day. When we hit the table header
("Exercise ... Sets Reps Weight ..."), start parsing rows until we hit
"Staff Member Notes" or a new "Week N, Day N" header.
"""
import json
import re
